...
public class DBHandler {
    ...
    private DBHandler() {
        ...
        int demo_orgID = 0;
        addOrganizationOpportunity(organizations.get(demo_orgID), opportunities.get(demo_orgID));
    }
    ...
    public static DBHandler setUp(Context ctx){
        if (instance == null && ctx != null){
            ...
            instance.sql_interface = DBSQL.getInstance(mContext);
        }
    ...
    public List<Voluntary> getVoluntaries() { return extendedVoluntaryList; }

    public List<Organization> getOrganizations() { return extendedOrganizationList; }
    ...
    public Opportunity getOpportunity(int id){ return getOpportunitiesList().get(id); }
    ...
    private void loadInMemoryDataBase(){
        ...
        opportunities = Arrays.asList(
                new Opportunity(0, "Asa Norte", 5, "Madeira Hoje", "Trabalhos voluntários de marcenaria", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(0), R.drawable.logo),
                new Opportunity(1, "Asa Sul", 1, "Ajude nos Gastos", "Trabalhos voluntários de acessoria", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(1)),
                new Opportunity(2, "Lago Norte", 2, "Acessoria de Informação", "Trabalhos voluntários recolhimento de informações", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(2)),
                new Opportunity(3, "Cruzeiro", 4, "Meninas na sociedade", "Trabalhos de inserção de meninas na computação", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(3)),
                new Opportunity(4, "Samambaia", 2, "Acessoria Financeira", "Trabalhos voluntários de acessoria", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(4)),
                new Opportunity(5, "Taguatinga", 4, "Ajude nos gastos", "Trabalhos voluntários de acessoria", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(5)),
                new Opportunity(6, "Ceilândia", 5, "Doe um Brinquedo", "Trabalhos voluntários de coleta de doações", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(6)),
                new Opportunity(7, "São Sebastião", 8, "Fazer a Diferença", "Trabalhos voluntários de coleta de doações", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(7)),
                new Opportunity(8, "Riacho Fundo", 1, "A mudança em nós", "Trabalhos voluntários de sustentabilidade", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(8)),
                new Opportunity(9, "Núcleo Bandeirante", 2, "Todos pelo mesmo!", "Trabalhos que promovem a igualdade de gênero", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(9)),
                new Opportunity(10, "Gama", 4, "Education", "Trabalhos voluntários de ensino em escolas públicas", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(10)),
                new Opportunity(11, "Planaltina", 5, "InfoTudo", "Trabalhos voluntários informação da população", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(11)),
                new Opportunity(12, "Asa Norte", 8, "Materialize", "Trabalhos voluntários de criação de objetos com materiais reciclados", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(12)),
                new Opportunity(13, "Santa Maria", 4, "Morata", "Trabalhos voluntários de ajudas humanitárias", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(13)),
                new Opportunity(14, "Setor Sudoeste", 7, "Você Visível", "Trabalhos voluntários conscientização social", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(14)),
                new Opportunity(15, "Setor Noroeste", 5, "Saúde Voluntária", "Trabalhos voluntários conscientização social", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(15)),
                new Opportunity(16, "Gama", 8, "Saúde Hoje", "Trabalhos voluntários de conscientização social", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(16)),
                new Opportunity(17, "Asa Norte", 1, "Informatica +40", "Trabalhos voluntários inclusão digital", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(17)),
                new Opportunity(18, "Lago Norte", 3, "DF Sutentável", "Trabalhos voluntários de sustentabilidade", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(18)),
                new Opportunity(19, "Asa Sul", 1, "Cozinha para todos", "Trabalhos voluntários para levar comida aos pobres", getCalendar("01/01/2017"), getCalendar("01/02/2017"), organizations.get(19))
        );
